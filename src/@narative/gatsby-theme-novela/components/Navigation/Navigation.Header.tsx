    ...
    <Section>
      <NavContainer>
        <LogoLink
          ...
          aria-label="Theres no place like home!"
        ...
        >
          ...
          <Logo fill={fill} />
          <Hidden>Theres no place like home!</Hidden>
        </LogoLink>
        <NavControls>
          {showBackArrow ? (
            <button
...
function DarkModeToggle() {
  ...
  return (
    <IconWrapper
      ...
      data-a11y="false"
      aria-label={isDark ? "turn on the light" : "make it dark"}
      title={isDark ? "turn on the light" : "make it dark"}
    >
