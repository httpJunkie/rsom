...
A project that I just finished up with my team from [@KendoReact](https://twitter.com/kendoreact) is an article where we ask 25 React developers about their tips on being productive in React.  

Check out the link: []()

https://github.com/httpJunkie/rsom
