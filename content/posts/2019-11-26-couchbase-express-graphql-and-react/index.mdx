...
In Couchbase Server you can bring your SQL skills and they are transferable to our NoSQL solution using a technology that is built in called [N1QL (SQL for JSON) Database Query Language](https://www.couchbase.com/products/n1ql).
